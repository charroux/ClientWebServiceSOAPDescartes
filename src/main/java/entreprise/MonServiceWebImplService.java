 ...
 * 
 */
@WebServiceClient(name = "MonServiceWebImplService", targetNamespace = "http://entreprise/", wsdlLocation = "http://localhost:8080/WS/MonServiceWeb?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MONSERVICEWEBIMPLSERVICE_QNAME = new QName("http://entreprise/", "MonServiceWebImplService");
    ...
    public MonService getMonServiceWebImplPort() {
        return super.getPort(new QName("http://entreprise/", "MonServiceWebImplPort"), MonService.class);
    }
     ...
     */
    @WebEndpoint(name = "MonServiceWebImplPort")
    public MonService getMonServiceWebImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://entreprise/", "MonServiceWebImplPort"), MonService.class, features);
    }
